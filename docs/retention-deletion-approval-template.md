...
- Drive backup 管理フォルダ配下、または個別 backup URL を確認済み
...
Drive backup path: データ設計・イベント設計 / 最終出力置き場 / ICE_20230825_report
Drive backup閲覧確認者:
...
- Drive backup 管理フォルダ配下に確認できない場合は、個別 backup URL、
  閲覧確認者、確認日時、例外理由を必須にする。
