...
- 複数管理者を実際に追加した後のIAP policy / service allowlist drift確認
...
- Drive backup retention確認: 管理フォルダ配下未確認時は個別backup URL必須、GCS削除不可
...
- Drive backup管理フォルダ実パス、運用担当、例外時の個別backup URL必須条件を明記
